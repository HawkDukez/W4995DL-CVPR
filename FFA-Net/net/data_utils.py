...
pwd=os.getcwd()
print(pwd)
path='/home/pz2272/train/Separate/'
...
NASA_train_loader=DataLoader(dataset=RESIDE_Dataset(path+'train',train=True,size=crop_size),batch_size=BS,shuffle=True)
NASA_test_loader=DataLoader(dataset=RESIDE_Dataset(path+'test',train=False,size='whole img'),batch_size=1,shuffle=False)
